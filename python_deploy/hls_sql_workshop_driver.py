...
# MAGIC   4. **FOURTH** once this notebook finishes executing, **you will need to manually run the workflow that it generates**. The name of the workflow can be found in the output of the last cell.
# MAGIC   ![](python_deploy/img/workflow_cell_output.png)
